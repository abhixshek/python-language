import dir3.dir4.calculator3


print(dir3.dir4.calculator3) # its picking the calculator module in the sub-directory of relative_imports, i.e. from this module's directory inside.
